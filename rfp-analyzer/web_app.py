...
web_app.py
----------
**Production entry point** — FastAPI web interface for the RFP Analyzer.
...
Supports multi-file upload with optional Phase 0 document-consolidation pipeline.

See main.py for the CLI companion (batch / scripted runs).
"""
